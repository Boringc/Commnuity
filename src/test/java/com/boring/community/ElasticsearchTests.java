...
import com.boring.community.dao.elasticsearch.DiscussPostRepository;
...
public class ElasticsearchTests {
    ...
    public void testInsertList(){
        ...
        discussPostRepository.saveAll(discussMapper.selectDiscussPosts(154,0,100));
    }

    @Test
    public void testUpdate(){
        DiscussPost post = discussMapper.selectDiscussPostById(231);
        post.setContent("我是新来的，使劲灌水");
